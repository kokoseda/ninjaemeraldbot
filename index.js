...
client.on('message', message => {
  ...
  .setColor("#000000")
  .addField("Done | تــــم" , ":envelope: | :sleuth_or_spy: :fast_forward: Check Your DM :white_check_mark: ")
...
client.on('guildDelete', guild => {
  client.channels.get("499257590077718528").send(`:negative_squared_cross_mark: **${client.user.tag} طلع من سيرفر
Server name: __${guild.name}__
Server owner: __${guild.owner}__
Server id: __${guild.id}__
Server Count: __${guild.memberCount}__**`)
...
client.on('message', message => {
    ...
    if (message.content.startsWith(prefix + 'setStreaming')) {
      if (!permium.includes(message.author.id)) return message.channel.send("<@449313863494664214> only this guy can do restart the bot so don't try again 😉.");
      message.delete();
